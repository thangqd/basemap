...
merge_sprites_and_json(
    sprite_image_1_path='./openmaptiles/sprite1/32/sprite@2x.png',
    json_1_path='./openmaptiles/sprite/32/sprite@2x.json',
   
    sprite_image_2_path='./openmaptiles/sprite1/32/sprite@2x.png',
    json_2_path='./openmaptiles/sprite/32/sprite@2x.json',
   
    output_image_path='./openmaptiles/sprite2/32/sprite@2x.png',
    output_json_path='./openmaptiles/sprite2/32/sprite@2x.json'
)