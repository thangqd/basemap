...
# Example usage
folder_path = "./openmaptiles/sprite/32"  # Replace with your folder path
output_image_path = "./openmaptiles/sprite/32/sprite@2x.png"
json_output_path = "./openmaptiles/sprite/32/sprite@2x.json"
