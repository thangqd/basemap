...
# Example usage
folder_path = "./openmaptiles/sprite/16"  # Replace with your folder path
output_image_path = "./openmaptiles/sprite/16/sprite.png"
json_output_path = "./openmaptiles/sprite/16/sprite.json"
